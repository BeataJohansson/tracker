...
class ObjectTracking:
    ...
    rolo_weights_file = '/Users/beatajohansson/Desktop/Object-Tracking-using-CNN-and-RNN/model_step6_exp1.ckpt' 
    ...
    def training(self):
        ...
        log_file = open("/Users/beatajohansson/Desktop/Object-Tracking-using-CNN-and-RNN/Output/training-20-log.txt", "a") #open in append mode
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(epoches):
                ...
                x_path = os.path.join('/Users/beatajohansson/Desktop/Object-Tracking-using-CNN-and-RNN/Data', sequence_name, 'yolo_out/')
                y_path = os.path.join('/Users/beatajohansson/Desktop/Object-Tracking-using-CNN-and-RNN/Data', sequence_name, 'groundtruth_rect.txt')
                self.output_path = os.path.join('/Users/beatajohansson/Desktop/Object-Tracking-using-CNN-and-RNN//DATA', sequence_name, 'rolo_out_train/')
    ...
    def TrackerModel(self):
            ...
            self.rolo_utils= rutils.ROLO_utils()
            self.training()
